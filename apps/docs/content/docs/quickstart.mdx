...
const wm = new WistMail({
  ...
  baseUrl: 'https://your-wistfare.com',
})
...
wm = WistMail(
    ...
    base_url="https://your-wistfare.com",
)
...
<Tab value="cURL">
```bash
curl https://your-wistfare.com/api/v1/emails/eml_abc123 \
  -H "X-API-Key: wm_your_api_key"
```
</Tab>
</Tabs>
...
<Tab value="cURL">
```bash
curl -X POST https://your-wistfare.com/api/v1/webhooks \
  -H "X-API-Key: wm_your_api_key" \
  -H "Content-Type: application/json" \
  -d '{
    "url": "https://yourapp.com/webhooks/email",
