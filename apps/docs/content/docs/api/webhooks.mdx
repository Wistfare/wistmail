...
<Tab value="cURL">
```bash
curl https://mail.wistfare.com/api/v1/webhooks \
  -H "X-API-Key: wm_your_api_key"
```
</Tab>
</Tabs>
...
<Tab value="cURL">
```bash
curl -X PATCH https://mail.wistfare.com/api/v1/webhooks/whk_abc123 \
  -H "X-API-Key: wm_your_api_key" \
  -H "Content-Type: application/json" \
  -d '{
    "events": ["email.delivered", "email.bounced", "email.opened", "email.clicked"]
...
<Tab value="cURL">
```bash
curl -X DELETE https://mail.wistfare.com/api/v1/webhooks/whk_abc123 \
  -H "X-API-Key: wm_your_api_key"
```
</Tab>
</Tabs>
...
<Tab value="cURL">
```bash
curl -X POST https://mail.wistfare.com/api/v1/webhooks/whk_abc123/test \
  -H "X-API-Key: wm_your_api_key"
```
</Tab>
</Tabs>
